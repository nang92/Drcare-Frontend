...
class ManageSchedule extends Component {
  ...
  handleSaveSchedule = async () => {
    ...
    let result = [];
    if (!currentDate) {
      toast.error('Please slelect Date');
      return;
    }
    if (selectedDoctor && _.isEmpty(selectedDoctor)) {
      toast.error('Please slelect Doctor');
      return;
    }
    ...
    if (rangeTime && rangeTime.length > 0) {
      ...
      if (selectedTime && selectedTime.length > 0) {
        ...
        toast.error('Please slelect time');
        return;
      }
    }
          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-12">
                <button className="btn-primary mt-3" onClick={() => this.handleSaveSchedule()}>
